package ru.practicum.ewm.service.event.specification;
...
public class EventSpecification {
    ...
    public static Specification<Event> eventStatusEquals(Event.State eventState) {
        return (root, query, criteriaBuilder) -> criteriaBuilder.equal(root.get("state"), eventState);
    }

    public static Specification<Event> eventStatusIn(List<Event.State> states) {
        if (states == null) {
            return null;
        }
